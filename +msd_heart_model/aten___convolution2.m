classdef aten___convolution2 < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %aten___convolution2 Auto-generated custom layer
    % Auto-generated by MATLAB on 16-Jun-2024 19:15:22
    ...
    methods
        function obj = aten___convolution2(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [convolution_input_1] = tracedPyTorchFunction(obj,convolution_argument1_1,isForward,predict)
            ...
            [convolution_input_1] = msd_heart_model.ops.pyConvolution(convolution_argument1_1, convolution_weight_1, convolution_6, convolution_30, convolution_31, convolution_32, convolution_12, convolution_33, convolution_9);
        end
