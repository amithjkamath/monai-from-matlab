classdef batchnorm_torchmangle53_BatchNorm3d < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %batchnorm_torchmangle53_BatchNorm3d Auto-generated custom layer
    ...
    methods
        function obj = batchnorm_torchmangle53_BatchNorm3d(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
