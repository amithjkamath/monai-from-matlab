classdef aten___convolution15 < nnet.layer.Layer & nnet.layer.Formattable & ...
        nnet.layer.AutogeneratedFromPyTorch & nnet.layer.Acceleratable
    %aten___convolution15 Auto-generated custom layer
    ...
    methods
        function obj = aten___convolution15(Name, Type, InputNames, OutputNames)
            obj.Name = Name;
            obj.Type = Type;
            obj.NumInputs = 1;
            obj.NumOutputs = 1;
        ...
        function [convolution_18] = predict(obj,convolution_argument1_1)
            ...
            [convolution_18] = tracedPyTorchFunction(obj,convolution_argument1_1,false,"predict");
            
            
            [convolution_18] = msd_heart_model.ops.labelWithPropagatedFormats(convolution_18, "BCSSS");
            convolution_18 = convolution_18.value ;
            
        end
        
        
        
        function [convolution_18] = forward(obj,convolution_argument1_1)
            
            %Use the input format inferred by the importer to permute the input into reverse-PyTorch dimension order
            [convolution_argument1_1, convolution_argument1_1_format] = msd_heart_model.ops.permuteToReversePyTorch(convolution_argument1_1, 'BCSSS', 5);
            [convolution_argument1_1] = struct('value', convolution_argument1_1, 'rank', int64(5));
            
            [convolution_18] = tracedPyTorchFunction(obj,convolution_argument1_1,true,"forward");
        ...
        function [convolution_18] = tracedPyTorchFunction(obj,convolution_argument1_1,isForward,predict)
            ...
            [convolution_18] = msd_heart_model.ops.pyConvolution(convolution_argument1_1, convolution_weight_1, convolution_6, convolution_29, convolution_30, convolution_31, convolution_12, convolution_32, convolution_9);
        end
